...
if __name__ == '__main__':
    ...
    for path in args.table_paths:
        ...
        if args.heatmap:
            ...
            levels = {key_map[c]: list(df[key_map[c]].unique()) for c in key_order}
        else:
        ...
        for m in args.measures:
            ...
            if args.heatmap:
                ...
                cbar_ax = fig.add_axes([.63, .3, .03, .4])
                ...
                for i, var_r in enumerate(row_iter):
                    ...
                    for j, var_c in enumerate(col_iter):
                        ...
                        ax.set_xlabel(col_lab_str + ax.get_xlabel())
                        ax.set_ylabel(row_lab_str + ax.get_ylabel())
