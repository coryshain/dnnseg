...
if __name__ == '__main__':
    ...
    argparser.add_argument('-m', '--measures', nargs='+', default=default_measures, help='(List of) regex on measures (column names of eval table) to plot.')
    ...
    measures = [re.compile(x) for x in args.measures]
